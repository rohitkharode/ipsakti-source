...
export const Route = createFileRoute("/cases")({
  head: () => ({
    meta: [
      { title: "Cases — IP-SAKTI" },
      {
        name: "description",
        content:
          "Search and review Ayurveda classification and IP research cases.",
      },
      { property: "og:title", content: "Cases — IP-SAKTI" },
      {
        property: "og:description",
        content: "Search and review research cases.",
      },
  ...
  return (
    <>
      <PageHeader
        ...
        title="Cases"
        description="Search assessment history, monitor reviews, and return to supporting evidence."
      />
      <Panel>
        <div className="flex flex-col gap-3 border-b border-border p-5 md:flex-row">
          ...
          <button
            ...
            className="flex min-h-11 items-center justify-center gap-2 rounded-lg border border-input px-4 text-sm font-semibold"
          >
          ...
          <div className="divide-y divide-border">
            {filtered.map((item) => (
              <Link
                ...
                className="grid gap-3 p-5 hover:bg-muted/50 md:grid-cols-[110px_1.4fr_1fr_150px_120px_130px] md:items-center"
              >
