 ...
 */
export async function ensureEmbeddings(limit = 100): Promise<{ embedded: number; remaining: number; skipped: boolean }> {
  ...
  // instead of retaining a hidden Lovable Gateway dependency.
  void limit;
